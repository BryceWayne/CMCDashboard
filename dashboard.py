...
risk.line(x='Date', y="L2", source=source, line_width=1, line_alpha=0.8, alpha=0.8, line_color='Buy')
risk.line(x='Date', y="L3", source=source, line_width=1, line_alpha=0.6, alpha=0.6, line_color='Buy')
risk.line(x='Date', y="L4", source=source, line_width=1, line_alpha=0.4, alpha=0.4, line_color='Buy')
risk.line(x='Date', y="L5", source=source, line_width=1, line_alpha=0.4, alpha=0.4, line_color='red')
